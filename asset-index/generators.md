...
- **形式**: ローカルHTML（共有ドライブ／メール添付。ホスト先URLは未定）
...
- **版**:
  - 草薙 原案: `モグラたたきフレーズゲーム.html`
  - 肥後 改良版: `モグラたたきフレーズゲーム__higo.html`（草薙版をClaudeチャットで読み込み、見た目を改良。今後の案＝モグラに動き／選択肢を隠した状態での成立／叩く動作・ビジュアル／単語表示時間デフォルト30秒）
